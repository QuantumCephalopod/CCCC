...
1. **Create** – Core architecture notes and policy files
   ...
   - Move recursive design discussions (`z.CULTIVATE/ARCHIVE/Recursive_Tetrahedral_Principle.md`) into this domain for historical reference.
...
4. **Cultivate** – State maps and indices
   - Keep `z.CULTIVATE.md`, `INDEX.md`, and generated analytics (`y.CONTROL/DATA/state_graph.dot`) in this area. Add a short README section linking to them for quick orientation.
