...
ROOT = repo_root()
DATA_DIR = ROOT / "y.Utilities" / "DATA"
CULTIVATE_MAP = ROOT / "z.Research" / "z.Research.md"
...
def main() -> None:
    ...
    if args.sl33p:
        ...
        subprocess.run(["python", str(ROOT / "y.Utilities" / "yz" / "AGENT_tools" / "sl33p" / "o.sl33p.py")], env=env)
